...
| Expose a Lost.Sector action or query not covered above | Extend the existing command in `lostsector.campaign.rulecmd` that owns the feature, delegating mechanics to their owner; see [project routing](RULES.md#project-routing) |
