...
| `kesteven/quest/*Intel` | Job intel: `OperationLifesaverIntel`, `CacheIntel`. Jobs 1, 3 and 5 use `QuestIntel` from `KestevenJob1Module`, `KestevenJob3Module` and `KestevenJob5Module`. |
