...
| `nskr_isKStage N`, `nskr_isAtLeastKStage N`, `nskr_isAtMostKStage N` | Condition predicates on the quest stage, compared as the legacy int of `KestevenQuest.stage()`. |
