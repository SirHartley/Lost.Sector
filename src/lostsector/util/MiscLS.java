...
public class MiscLS {
    ...
    static void log(final String message) {
        Global.getLogger(MiscLS.class).info(message);
    }
    ...
    public static SectorEntityToken getRandomMarket(Random random, boolean allowPiratesEtc){
        ...
        MarketAPI randomMarket = markets.get(MathUtilLS.getSeededRandomNumberInRange(0, markets.size()-1, random));
    ...
    public static String getRandomGreekLetter(Random random, boolean capitalized) {
        if (!capitalized) {
            return GREEK_LETTERS.get(MathUtilLS.getSeededRandomNumberInRange(0, GREEK_LETTERS.size() - 1, random));
        } else {
            return capitalizeFirstLetter(GREEK_LETTERS.get(MathUtilLS.getSeededRandomNumberInRange(0, GREEK_LETTERS.size() - 1, random)));
        }
    }
