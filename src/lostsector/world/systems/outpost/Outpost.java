package lostsector.world.systems.outpost;
...
public class Outpost {
	...
	static void log(final String message) {
		Global.getLogger(Outpost.class).info(message);
	}
	...
	public static void generate(SectorAPI sector) {
		...
		//gate
		boolean hasGate = MiscLS.hasGate(system);
		if (!hasGate) {
		...
		//relay
		boolean hasRelay = MiscLS.hasRelay(system);
		if (!hasRelay) {
		...
		} else MiscLS.getRelay(system).setFaction("kesteven");
