...
//////////////////////
package lostsector.world.systems.frost;
...
public class Frost {
	...
	static void log(final String message) {
		Global.getLogger(Frost.class).info(message);
	}
	...
	public static void generate(SectorAPI sector) {
		...
		//DORMANT
		for (int x = 0; x < 8; x++) {
			MiscLS.addDormant(MiscLS.getRandomLocationInSystem(system, false, true, new Random()), "enigma", 5f, 100f, 0.50f, 0.25f, 0.75f, 0f, 0, 0);
		}
		//////DERELICT TIME
