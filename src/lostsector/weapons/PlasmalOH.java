...
public class PlasmalOH implements OnHitEffectPlugin {
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
        ...
        //AOE DMG
        CombatUtilsLS.applyAOEDamage(projectile.getSource(), target, point, projectile.getDamageAmount(), projectile.getDamageType(), 600f, false);
        ...
        CombatUtilsLS.createHitParticles(point, projectile.getFacing(), 45f, HIT_PARTICLE_COLOR, 25f, 5f, 0.3f, 1.0f, 50f, 3.0f);
