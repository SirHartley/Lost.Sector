...
public class nskr_collectorEffect implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        ...
        ON_SHOT_PARTICLE_COUNT.put("NSKR_SMOKE_5", 5);
    }
    ...
    static {
        ...
        PARTICLE_TYPE.put("NSKR_SMOKE_3", "SMOOTH");
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(245, 200, 205, 75));
        PARTICLE_COLOR.put("NSKR_SMOKE_5", new Color(245, 200, 205, 55));
        PARTICLE_COLOR.put("NSKR_SMOKE_3", new Color(255, 39, 96, 55));
        PARTICLE_COLOR.put("NSKR_FLASH_FRINGE_1", new Color(255, 39, 96, 255));
        PARTICLE_COLOR.put("NSKR_FLASH_CORE_1", new Color(255, 95, 137, 255));
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("NSKR_FLASH_FRINGE_1", 80f);
        PARTICLE_SIZE_MIN.put("NSKR_FLASH_CORE_1", 40f);
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("NSKR_FLASH_FRINGE_1", 80f);
        PARTICLE_SIZE_MAX.put("NSKR_FLASH_CORE_1", 40f);
    }
    ...
    static {
        ...
        PARTICLE_DURATION_MAX.put("NSKR_FLASH_FRINGE_1", 0.15f);
        PARTICLE_DURATION_MAX.put("NSKR_FLASH_CORE_1", 0.1f);
    }
