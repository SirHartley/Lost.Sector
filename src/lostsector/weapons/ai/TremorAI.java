...
public class TremorAI extends BaseMissile {
    ...
    public TremorAI(MissileAPI missile, ShipAPI launchingShip) {
    ...
    public void advance(float amount) {
        ...
        if (adjustedDistance >= 1000f) {
            ...
            weaveLevel = MathUtilLS.lerp(1f, 0f, (adjustedDistance - 500f) / 500f);
        }
