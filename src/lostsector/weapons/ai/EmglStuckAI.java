...
import lostsector.weapons.EmglScript;
...
public class EmglStuckAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public EmglStuckAI(MissileAPI missile, ShipAPI launchingShip) {
    ...
    public void advance(float amount) {
        ...
        if (!runOnce) {
            runOnce = true;
            List<CombatEntityAPI> list = ((EmglScript) missile.getWeapon().getEffectPlugin()).getHITS();
            ...
            ((EmglScript) missile.getWeapon().getEffectPlugin()).setDetonation(anchor);
            ...
            if (anchor == null || ((EmglScript) missile.getWeapon().getEffectPlugin()).getDetonation(anchor)) {
