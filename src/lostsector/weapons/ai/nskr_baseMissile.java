...
public class nskr_baseMissile implements MissileAIPlugin, GuidedMissileAI {
    ...
    static List<ShipAPI> getSortedDirectTargets(ShipAPI launchingShip) {
        List<ShipAPI> directTargets = combatUtil.getShipsWithinRange(launchingShip.getMouseTarget(), 300f);
    ...
    public nskr_baseMissile(MissileAPI missile, ShipAPI launchingShip) {
