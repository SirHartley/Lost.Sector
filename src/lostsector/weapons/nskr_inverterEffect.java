...
public class nskr_inverterEffect implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        ...
        ON_SHOT_PARTICLE_COUNT.put("NSKR_SMOKE_5", 12);
    }
    ...
    static {
        ...
        PARTICLE_COLOR.put("NSKR_SMOKE_3", new Color(199, 195, 212, 75));
        PARTICLE_COLOR.put("NSKR_SMOKE_5", new Color(166, 184, 255, 55));
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("NSKR_FLASH_FRINGE_1", 100f);
        PARTICLE_SIZE_MIN.put("NSKR_FLASH_CORE_1", 60f);
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("NSKR_FLASH_FRINGE_1", 100f);
        PARTICLE_SIZE_MAX.put("NSKR_FLASH_CORE_1", 60f);
    }
    ...
    static {
        ...
        PARTICLE_DURATION_MIN.put("NSKR_SMOKE_5", 0.4f);
    ...
    static {
        ...
        PARTICLE_DURATION_MAX.put("NSKR_SMOKE_5", 0.9f);
