...
public class nskr_hshotgunEffect implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    */
    ...
    static {
        ...
        ON_SHOT_PARTICLE_COUNT.put("NSKR_SMOKE_5", 8);
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("NSKR_FLASH_FRINGE_1", 90f);
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("NSKR_FLASH_FRINGE_1", 90f);
    ...
    static {
        ...
        PARTICLE_OFFSET_MAX.put("NSKR_SMOKE_3", 60f);
    ...
    //Instantiator
    public nskr_hshotgunEffect() {}

    private final int PROJ_COUNT = 5;
    private final String SHOTGUN_WEAPON_ID = "nskr_hshotgun_sub";
    ////////////////////////
    //ON FIRE STUFF
    ////////////////////////
    @Override
