        ...
        public void advance(float amount) {
            ...
            for (CombatEntityAPI removal : entitiesCopy) {
                ...
                if (removal instanceof DamagingProjectileAPI){
                    if (((DamagingProjectileAPI) removal).getDamageAmount() < EmflakEffect.FUZE_MIN_DMG) entitiesFuze.remove(removal);
                }
            }
            ...
            if (!entitiesFuze.isEmpty()) {
                for (CombatEntityAPI entity : entities) {
                    ...
                    mult = 1f;
                    mult = MathUtilLS.normalize(dist, 0f, EmflakEffect.EXPLOSION_RADIUS);
                    mult = MathUtilLS.inverse(mult);
                ...
                //blast sprite
                BlastSpriteCreator.blastSpriteListener shockwave = new BlastSpriteCreator.blastSpriteListener(ship, projectile.getLocation(), 0.67f, EmflakEffect.EXPLOSION_RADIUS-50f,
