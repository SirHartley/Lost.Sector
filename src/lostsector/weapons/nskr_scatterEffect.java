...
public class nskr_scatterEffect implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    */
    ...
    static {
        USED_IDS.add("NSKR_SMOKE_1");
        USED_IDS.add("NSKR_SMOKE_3");
        USED_IDS.add("NSKR_SMOKE_5");
        USED_IDS.add("NSKR_FLASH_CORE_1");
        USED_IDS.add("NSKR_FLASH_FRINGE_1");
    }
    ...
    static {
        ...
        ON_SHOT_PARTICLE_COUNT.put("NSKR_FLASH_FRINGE_1", 1);
        ON_SHOT_PARTICLE_COUNT.put("NSKR_FLASH_CORE_1", 1);
        ON_SHOT_PARTICLE_COUNT.put("NSKR_SMOKE_5", 15);
    }
    ...
    static {
        ...
        PARTICLE_TYPE.put("NSKR_FLASH_FRINGE_1", "BRIGHT");
        PARTICLE_TYPE.put("NSKR_FLASH_CORE_1", "BRIGHT");
    }

    //What color does the particles have?
    private static final Map<String, Color> PARTICLE_COLOR = new HashMap<>();
    static {
        PARTICLE_COLOR.put("default", new Color(212, 195, 195, 75));
        PARTICLE_COLOR.put("NSKR_SMOKE_3", new Color(212, 195, 195, 75));
        PARTICLE_COLOR.put("NSKR_SMOKE_5", new Color(255, 166, 186, 55));
        PARTICLE_COLOR.put("NSKR_FLASH_FRINGE_1", new Color(255, 163, 179, 255));
        PARTICLE_COLOR.put("NSKR_FLASH_CORE_1", new Color(255, 105, 119, 255));
    }

    //What's the smallest size the particles can have?
    private static final Map<String, Float> PARTICLE_SIZE_MIN = new HashMap<>();
    static {
        PARTICLE_SIZE_MIN.put("default", 2f);
        PARTICLE_SIZE_MIN.put("NSKR_FLASH_FRINGE_1", 110f);
        PARTICLE_SIZE_MIN.put("NSKR_FLASH_CORE_1", 70f);
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("NSKR_FLASH_FRINGE_1", 110f);
        PARTICLE_SIZE_MAX.put("NSKR_FLASH_CORE_1", 70f);
    }
    ...
    static {
        ...
        PARTICLE_VELOCITY_MIN.put("NSKR_FLASH_FRINGE_1", 0f);
        PARTICLE_VELOCITY_MIN.put("NSKR_FLASH_CORE_1", 0f);
    }
    ...
    static {
        ...
        PARTICLE_VELOCITY_MAX.put("NSKR_FLASH_FRINGE_1", 0f);
        PARTICLE_VELOCITY_MAX.put("NSKR_FLASH_CORE_1", 0f);
        PARTICLE_VELOCITY_MAX.put("NSKR_SMOKE_5", 15f);
    }
    ...
    static {
        ...
        PARTICLE_DURATION_MIN.put("NSKR_SMOKE_3", 0.4f);
        PARTICLE_DURATION_MIN.put("NSKR_SMOKE_5", 0.6f);
        PARTICLE_DURATION_MIN.put("NSKR_FLASH_FRINGE_1", 0.1f);
        PARTICLE_DURATION_MIN.put("NSKR_FLASH_CORE_1", 0.05f);
    }
    ...
    static {
        PARTICLE_DURATION_MAX.put("default", 0.7f);
        PARTICLE_DURATION_MAX.put("NSKR_SMOKE_3", 0.7f);
        PARTICLE_DURATION_MAX.put("NSKR_SMOKE_5", 1.2f);
        PARTICLE_DURATION_MAX.put("NSKR_FLASH_FRINGE_1", 0.1f);
        PARTICLE_DURATION_MAX.put("NSKR_FLASH_CORE_1", 0.05f);
    }
    ...
    static {
        ...
        PARTICLE_OFFSET_MIN.put("NSKR_FLASH_FRINGE_1", 0f);
        PARTICLE_OFFSET_MIN.put("NSKR_FLASH_CORE_1", 0f);
    }
    ...
    static {
        ...
        PARTICLE_OFFSET_MAX.put("NSKR_SMOKE_3", 15f);
        PARTICLE_OFFSET_MAX.put("NSKR_FLASH_FRINGE_1", 0f);
        PARTICLE_OFFSET_MAX.put("NSKR_FLASH_CORE_1", 0f);
        PARTICLE_OFFSET_MAX.put("NSKR_SMOKE_5", 3f);
    }
    ...
    static {
        ...
        PARTICLE_ARC.put("NSKR_SMOKE_3", 10f);
        PARTICLE_ARC.put("NSKR_FLASH_FRINGE_1", 0f);
        PARTICLE_ARC.put("NSKR_FLASH_CORE_1", 0f);
        PARTICLE_ARC.put("NSKR_SMOKE_5", 180f);
    }
    ...
    //Instantiator
    public nskr_scatterEffect() {}

    private final int PROJ_COUNT = 20;
    private final String SHOTGUN_WEAPON_ID = "nskr_scatterm_clone";
    ////////////////////////
    //ON FIRE STUFF
    ////////////////////////
    @Override
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        for (int i = 0; i < PROJ_COUNT; i++) {
            //spread
            Vector2f drift = MathUtils.getPoint(weapon.getShip().getVelocity(), MathUtils.getRandomNumberInRange(-100f, 100f), weapon.getCurrAngle());
            WeaponAPI wep;
            wep = engine.createFakeWeapon(weapon.getShip(), SHOTGUN_WEAPON_ID);
            //spawn shotgun proj
            engine.spawnProjectile(weapon.getShip(), wep, SHOTGUN_WEAPON_ID,
                    projectile.getLocation(), weapon.getCurrAngle() + MathUtils.getRandomNumberInRange(-5.0f, 5.0f), drift);
            //remove og proj
