...
public class nskr_scannonmEffect implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(136, 138, 139, 125));
        PARTICLE_COLOR.put("NSKR_SMOKE_3", new Color(80, 86, 90, 105));
        PARTICLE_COLOR.put("NSKR_FLASH_FRINGE_1", new Color(193, 239, 255));
        PARTICLE_COLOR.put("NSKR_FLASH_CORE_1", new Color(241, 241, 255));
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("NSKR_FLASH_FRINGE_1", 25f);
        PARTICLE_SIZE_MIN.put("NSKR_FLASH_CORE_1", 10f);
    }

    //What's the largest size the particles can have?
    private static final Map<String, Float> PARTICLE_SIZE_MAX = new HashMap<>();
    static {
        PARTICLE_SIZE_MAX.put("default", 8f);
        PARTICLE_SIZE_MAX.put("NSKR_FLASH_FRINGE_1", 30f);
        PARTICLE_SIZE_MAX.put("NSKR_FLASH_CORE_1", 13f);
    }
    ...
    static {
        ...
        PARTICLE_VELOCITY_MAX.put("NSKR_SMOKE_5", 10f);
    }
    ...
    static {
        ...
        PARTICLE_DURATION_MIN.put("NSKR_FLASH_FRINGE_1", 0.04f);
        PARTICLE_DURATION_MIN.put("NSKR_FLASH_CORE_1", 0.02f);
    }
    ...
    static {
        ...
        PARTICLE_DURATION_MAX.put("NSKR_FLASH_FRINGE_1", 0.08f);
        PARTICLE_DURATION_MAX.put("NSKR_FLASH_CORE_1", 0.04f);
    }
    ...
    static {
        ...
        PARTICLE_ARC.put("NSKR_SMOKE_5", 30f);
    }
