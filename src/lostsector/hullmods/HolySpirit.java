...
import lostsector.campaign.customStart.abilities.ThronesGiftHolySpiritListener;

public class HolySpirit extends BaseHullMod {

    static void log(final String message) {
        Global.getLogger(HolySpirit.class).info(message);
    }
