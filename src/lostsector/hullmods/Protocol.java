...
public class Protocol extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        text.addPara(CHARGE_MODE_NAME, 0.0f, MiscLS.NICE_YELLOW, CHARGE_MODE_NAME);
        text.addPara("+75su/s max speed when moving forwards.", 0.0f, MiscLS.BON_GREEN, "75su/s");
        text.addPara("+200%% acceleration.", 0.0f, MiscLS.BON_GREEN, "200%");
        text.addPara("-60%% maneuverability otherwise.", 0.0f, MiscLS.TT_ORANGE, "60%");
        tooltip.addImageWithText(pad);

        text = tooltip.beginImageWithText("graphics/icons/hullsys/quantum_disruptor.png", 36.0f);
        text.addPara(PRECISION_MODE_NAME, 0.0f, MiscLS.NICE_YELLOW, PRECISION_MODE_NAME);
        text.addPara("+50%% damage for non-missile projectile weapons.", 0.0f, MiscLS.BON_GREEN, "50%");
        text.addPara("+25%% damage for beam weapons.", 0.0f, MiscLS.BON_GREEN, "25%");
        text.addPara("+150 units non-PD weapon range.", 0.0f, MiscLS.BON_GREEN, "150");
        text.addPara("-25%% rate of fire for non-missile weapons.", 0.0f, MiscLS.TT_ORANGE, "25%");
        tooltip.addImageWithText(pad);

        text = tooltip.beginImageWithText("graphics/icons/hullsys/fortress_shield.png", 36.0f);
        text.addPara(BULWARK_MODE_NAME, 0.0f, MiscLS.NICE_YELLOW, BULWARK_MODE_NAME);
        text.addPara("-33%% shield damage taken.", 0.0f, MiscLS.BON_GREEN, "33%");
        text.addPara("+100%% shield rotation and deployment rate.", 0.0f, MiscLS.BON_GREEN, "100%");
        text.addPara("+150 units PD weapon range.", 0.0f, MiscLS.BON_GREEN, "150");
        text.addPara("+75%% damage to missiles and fighters.", 0.0f, MiscLS.BON_GREEN, "75%");
        tooltip.addImageWithText(pad);
    }
