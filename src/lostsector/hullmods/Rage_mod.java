...
public class Rage_mod extends BaseHullMod {
		...
		if (data.triggered) {
			...
			if (sparkleInterval.intervalElapsed()) {
				for (int x = 0; x < 3; x++) {
					...
					if (ship != null) {
						//color fuckery
						Color color1 = MiscLS.randomiseColor(new Color(255, 100, 150, 255), 0, 100, 50, 0, true);
						Color color3 = MiscLS.randomiseColor(new Color(255, 100, 150, 155), 0, 100, 50, 0, true);
