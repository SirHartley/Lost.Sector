    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (tracker.intervalElapsed()) {
            for (Vector2f point : points) {
                ...
                boolean use = false;
                float curDist = CombatUtilsLS.getNearestEnemyShipDistance(ship, ship.getLocation(), ANALYSIS_RANGE);
                float posDist = CombatUtilsLS.getNearestEnemyShipDistance(ship, point, ANALYSIS_RANGE);
                ...
                possibleTargets.addAll(CombatUtilsLS.getProjectilesWithinRange(ship.getLocation(), 500f));
                possibleTargets.addAll(CombatUtilsLS.getMissilesWithinRange(ship.getLocation(), 400f));
