...
public class KaboomAI implements ShipSystemAIScript {
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (tracker.intervalElapsed()) {
            ...
            List<ShipAPI> ships = new ArrayList<>(CombatUtilsLS.getShipsWithinRange(ship.getLocation(), 1000f));
            List<ShipAPI> friendlies = new ArrayList<>(CombatUtilsLS.getShipsWithinRange(ship.getLocation(), 1000f));
