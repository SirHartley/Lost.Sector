...
import lostsector.shipsystems.ProjfieldStats;
...
public class ProjfieldAI implements ShipSystemAIScript {
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (timer.intervalElapsed()) {
            ...
            for (CombatEntityAPI possibleTarget : CombatUtils.getEntitiesWithinRange(ship.getLocation(), ProjfieldStats.getMaxRange(ship))){
