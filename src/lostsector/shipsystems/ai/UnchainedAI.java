...
public class UnchainedAI implements ShipSystemAIScript {
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (timer.intervalElapsed()) {
            ...
            possibleTargets.addAll(CombatUtilsLS.getProjectilesWithinRange(ship.getLocation(), 600f));
            possibleTargets.addAll(CombatUtilsLS.getMissilesWithinRange(ship.getLocation(), 750f));
            ...
            ships.addAll(CombatUtilsLS.getShipsWithinRange(ship.getLocation(), 400f));
