...
public class ProtocolAI implements ShipSystemAIScript {
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (timer.intervalElapsed()) {
            ...
            ships.addAll(CombatUtilsLS.getShipsWithinRange(ship.getLocation(), analysisRange+150f));
            ...
            fighters.addAll(CombatUtilsLS.getShipsWithinRange(ship.getLocation(), 400));
            ...
            possibleTargets.addAll(CombatUtilsLS.getMissilesWithinRange(ship.getLocation(), 600f));
