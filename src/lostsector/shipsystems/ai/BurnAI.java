...
import lostsector.shipsystems.DistortionBurnStats;
...
public class BurnAI implements ShipSystemAIScript {
    ...
    private boolean nothingCanStopMe(ShipAPI ship) {
        ...
        List<ShipAPI> consider = CombatUtilsLS.getShipsWithinRange(curr, SCAN_RANGE);
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (timer.intervalElapsed()) {
            ...
            //anti salamander
            for (MissileAPI m : CombatUtilsLS.getMissilesWithinRange(ship.getLocation(), 350f)){
            ...
            //anti-fighter / flank
            int targetCount = 0;
            for (ShipAPI s : CombatUtilsLS.getShipsWithinRange(ship.getLocation(), DistortionBurnStats.ARC_MAX_RANGE)){
