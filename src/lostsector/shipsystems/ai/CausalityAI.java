...
public class CausalityAI implements ShipSystemAIScript {
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (tracker.intervalElapsed()) {
            ...
            possibleTargets.addAll(CombatUtilsLS.getProjectilesWithinRange(ship.getLocation(), range));
            possibleTargets.addAll(CombatUtilsLS.getMissilesWithinRange(ship.getLocation(), range));
            ...
            if (flux>minToFail) failureChance = MathUtilLS.normalize(flux, minToFail, 1f);
