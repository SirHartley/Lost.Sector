...
public class BossPhaseStats extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        if (state == State.IN || state == State.ACTIVE) {
            ...
            Color color1b = new Color (MiscLS.clamp255((color1.getRed())), MiscLS.clamp255((color1.getGreen())), MiscLS.clamp255((color1.getBlue())), MiscLS.clamp255((color1.getAlpha())));
            //afterimage
