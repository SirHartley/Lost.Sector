...
import lostsector.hullmods.Aed;
...
public class KaboomStats extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        if (state == State.IN) {
            ...
            if (sparkleInterval.intervalElapsed()) {
                for (int x2 = 0; x2 < 3; x2++) {
                    ...
                    if (ship != null) {
                        Color color1 = MiscLS.randomiseColor(new Color(150,100,200,255),100,50,50,0,true);
                        Color color6 = MiscLS.randomiseColor(new Color(150,100,200,155),100,50,50,0,true);
        ...
        if (state == State.ACTIVE) {
            ...
            if (!explosions && frameSkip) {
                ...
                //AOE DAMAGE
                CombatUtilsLS.applyAOEDamage(ship, null, ship.getLocation(), EXPLOSION_DAMAGE_AMOUNT, DamageType.HIGH_EXPLOSIVE, EXPLOSION_PUSH_RADIUS, true);
                ...
                while (i < size) {
                    ...
                    if (tmp instanceof ShipAPI) {
                        ...
                        if ((victim.getShield() != null && victim.getShield().isOn() && victim.getShield().isWithinArc(
                            ...
                            for (int x = 0; x < 5; x++) {
                                EmpArcEntityAPI arc = engine.spawnEmpArcPierceShields(ship, CombatUtilsLS.getRandomPointOnShip(victim),
                                        empTarget,
