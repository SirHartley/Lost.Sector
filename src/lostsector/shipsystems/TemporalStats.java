...
public class TemporalStats extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        shipsInBounds.addAll(CombatUtilsLS.getShipsWithinRange(ship.getLocation(), ship.getCollisionRadius()));
        ...
        if (state == State.ACTIVE && OOB || timer<2.5f){
            ...
            if (Math.random() < 1.0f * (engine.getElapsedInLastFrame()*60f)) {
                ...
                particleVel = MathUtilLS.scaleVector(particleVel, 0.5f);
        ...
        if (state == State.OUT) {
            ...
            ship.setExtraAlphaMult(1f);
                ...
                if (Explosions) {
                    ...
                    //AOE DAMAGE
                    CombatUtilsLS.applyAOEDamage(ship, null, ship.getLocation(), EXPLOSION_DAMAGE_AMOUNT, DamageType.HIGH_EXPLOSIVE, EXPLOSION_PUSH_RADIUS, false);
