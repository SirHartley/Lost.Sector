...
public class EnigmaBlowerUpper extends BaseCampaignEventListener implements EveryFrameScript  {
    ...
    public EnigmaBlowerUpper() {
        super(false);
        //for intel
        this.firstTime = new Saved<>("frostFirstTime", true);
    }
    static void log(final String message) {
        Global.getLogger(EnigmaBlowerUpper.class).info(message);
    }
