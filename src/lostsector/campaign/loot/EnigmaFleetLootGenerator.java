...
public class EnigmaFleetLootGenerator extends BaseCampaignEventListener implements EveryFrameScript {
	...
	static void log(final String message) {
		Global.getLogger(EnigmaFleetLootGenerator.class).info(message);
	}

	public EnigmaFleetLootGenerator() {
		super(true);
	}
