...
public class EndingElizaDialog implements InteractionDialogPlugin {
    ...
    static void log(final String message) {
        Global.getLogger(ArtifactDialog.class).info(message);
    }
    ...
    public void optionSelected(String optionText, Object optionData) {
        ...
        if (optionData == OptionId.A3) {
            ...
            if (GamemodeManager.getMode() == GamemodeManager.gameMode.HELLSPAWN) HellSpawnEventIntel.get().addFactor(
                    new HellSpawnEventFactors(100+ MathUtilLS.getSeededRandomNumberInRange(3,10, getRandom()),
            ...
            //+rep
            float repPirates = MathUtilLS.getSeededRandomNumberInRange(0.25f, 0.30f, getRandom());
            //save to mem
            ...
            //hege & kesteven war
            float repKesteven = MathUtilLS.getSeededRandomNumberInRange(-0.90f, -0.80f, getRandom());
            //save to mem
            QuestUtil.setFloat(repKesteven,REP_KESTEVEN_KEY);
            float repHege = MathUtilLS.getSeededRandomNumberInRange(-0.70f, -0.65f, getRandom());
            //save to mem
            ...
            if(MiscLS.getAlice()!=null) {
                MiscLS.getAlice().getRelToPlayer().adjustRelationship(-0.75f, RepLevel.VENGEFUL);
            ...
            if(MiscLS.getJack()!=null) {
                MiscLS.getJack().getRelToPlayer().adjustRelationship(-0.75f, RepLevel.VENGEFUL);
