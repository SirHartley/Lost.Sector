...
public class EndingKestevenDialog implements InteractionDialogPlugin {
    //
    //
    //
    ...
    public void optionSelected(String optionText, Object optionData) {
        ...
        if (optionData == OptionId.A3) {
            ...
            MiscLS.getJack().setImportance(PersonImportance.VERY_HIGH);
            MiscLS.getAlice().setImportance(PersonImportance.VERY_HIGH);
            ...
            if(MiscLS.getEliza()!=null) {
                MiscLS.getEliza().getRelToPlayer().adjustRelationship(-0.75f, RepLevel.VENGEFUL);
            }
            //remove important
