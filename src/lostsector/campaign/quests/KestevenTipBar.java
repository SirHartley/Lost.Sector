...
import lostsector.campaign.intel.KestevenTipBarIntel;
...
public class KestevenTipBar extends BaseBarEvent {
    ...
    static void log(final String message) {
        Global.getLogger(KestevenTipBar.class).info(message);
    }
    ...
    public KestevenTipBar(String id) {
        this.id = id;
    ...
    public void init(InteractionDialogAPI dialog, Map<String, MemoryAPI> memoryMap) {
        ...
        if (money==0f) money = 1000f* MathUtilLS.getSeededRandomNumberInRange(10, 30, getRandom());
    ...
    public void optionSelected(String optionText, Object optionData) {
        ...
        if (optionData==OptionId.LEAVE_BOUGHT){
            ...
            //intel
            Global.getSector().getIntelManager().addIntel(new KestevenTipBarIntel(getTipLocation().getStarSystem(), id, getThemeType(getTipLocation())), false);
        ...
        //remnant
            ...
            for (SectorEntityToken e : Global.getSector().getHyperspace().getAllEntities()){
                ...
                if (e.getTags().contains(Tags.BEACON_LOW) || e.getTags().contains(Tags.BEACON_MEDIUM) || e.getTags().contains(Tags.BEACON_HIGH)){
                    ...
                    //hax
                    pickSystems.add(MiscLS.getNearestSystem(e.getOrbit().getFocus().getLocation()));
