...
public class KQuest5Bar extends BaseBarEvent {
    ...
    static void log(final String message) {
        Global.getLogger(KQuest5Bar.class).info(message);
    }
    ...
    public void init(InteractionDialogAPI dialog, Map<String, MemoryAPI> memoryMap) {
        ...
        asteria = MiscLS.getAsteria()!=null;
        initial = true;
        ...
        if (asteria){
            dialog.getVisualPanel().showLargePlanet(MiscLS.getAsteria());
        } else{
    ...
    public void optionSelected(String optionText, Object optionData) {
        ...
        disks = ArtifactDialog.getRecoveredSatelliteCount()>0;
