...
public class KQuest5ElizaBarSecond extends BaseBarEvent {
	...
	public void optionSelected(String optionText, Object optionData) {
		...
		if (optionData== OptionId.LEAVE){
			...
			if (count==1){
				...
				KQuest5ElizaBarMain.setDialogStage(2, KQuest5ElizaBarMain.INTRO_DIALOG_KEY);
			}
