...
public class CoreDialog implements InteractionDialogPlugin {
    ...
    public void optionSelected(String optionText, Object optionData) {
        ...
        if (optionData == OptionId.A2) {
            ...
            //acquire text
            int amount = MathUtilLS.getSeededRandomNumberInRange(50,100, getRandom());
            ...
            if (QuestUtil.getCompleted(ElizaDialog.AGREED_TO_HELP_KEY)){
