...
public class ComCrewsBonus implements EconomyTickListener, TooltipCreator {
	...
	static void log(final String message) {
		Global.getLogger(ComCrewsBonus.class).info(message);
	}

	protected long startTime = 0;
	public ComCrewsBonus() {
