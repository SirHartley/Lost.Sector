...
public class BlacksiteInfo {
    ...
    public BlacksiteInfo(SectorEntityToken entity, Random random) {
        ...
        this.count = MathUtilLS.getSeededRandomNumberInRange(1, 3, random);
        float mult = 1f;
        switch (this.count){
            case 1:
                mult = 0.67f;
        ...
        switch (faction){
            case Factions.PIRATES:
                this.points = MathUtilLS.getSeededRandomNumberInRange(150f, 175f, random) * mult;
                break;
            case Factions.LUDDIC_PATH:
                this.points = MathUtilLS.getSeededRandomNumberInRange(125f, 150f, random) * mult;
                break;
