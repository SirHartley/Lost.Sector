...
public class GuardSpawner extends BaseCampaignEventListener implements EveryFrameScript {
    //
    ...
    static void log(final String message) {
        Global.getLogger(GuardSpawner.class).info(message);
    }

    public GuardSpawner() {
        super(false);
        //how often we run logic
        this.counter = new Saved<>("guardCounter", 0.0f);
        this.respawnCounter = new Saved<>("respawnCounterGuard", 0.0f);
    ...
    public void advance(float amount) {
        ...
        if (fleets.isEmpty() && respawnCounter.val<=0f && MiscLS.kestevenExists()) {
