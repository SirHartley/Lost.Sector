...
public class AltEndingDialogTT extends PaginatedOptions {
    ...
    static void log(final String message) {
        Global.getLogger(AltEndingDialogTT.class).info(message);
    }
    ...
    protected void addOptions(boolean secondTime){
        ...
        } else if (!QuestUtil.getCompleted(AltEndingDialogLuddic.DIALOG_FINISHED_KEY)){
    ...
    protected void tachAgree(){
        ...
        //mad
        AltEndingDialogLuddic.makeMad(text, g, r);
        ...
        if (hybrasil!=null) {
            ...
            if (culann != null && culann.getFactionId() != null && culann.getFactionId().equals(Factions.TRITACHYON)) {
                culann.addCondition(LSIds.UNLIMITED_PRODUCTION_CHIP_CONDITION_ID);
            } else market.addCondition(LSIds.UNLIMITED_PRODUCTION_CHIP_CONDITION_ID);
        } else market.addCondition(LSIds.UNLIMITED_PRODUCTION_CHIP_CONDITION_ID);
    ...
    protected boolean validEntity(SectorEntityToken entity) {
        ...
        //DONE
        if (QuestUtil.getCompleted(AltEndingDialogLuddic.DIALOG_FINISHED_KEY)) return false;
