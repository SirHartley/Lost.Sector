...
public class LicensingFees implements EconomyTickListener, TooltipCreator {
	...
	public void reportEconomyMonthEnd()
	{
		...
		int curr = KestevenExportManager.getTotalLicenseProduction();
		int saved = KestevenExportManager.getSavedProduction();
		log("licensingFees " + curr +", " + saved);

		if (curr< saved){
			setFees(saved-curr);
		}
		KestevenExportManager.saveProduction(curr);
	}
