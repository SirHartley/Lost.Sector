...
import lostsector.campaign.quests.KestevenTipBar;

import java.awt.*;
import java.util.Map;
import java.util.Set;

public class KestevenTipBarIntel extends BaseIntelPlugin {
    ...
    static void log(final String message) {
        Global.getLogger(KestevenTipBarIntel.class).info(message);
    }

    //Initializer function
    public KestevenTipBarIntel(StarSystemAPI system, String id, String type) {
        this.system = system;
        this.id = id;
        this.type = type;
    ...
    public void cleanTipLocation(){
        ...
        data.put(KestevenTipBar.PAID_FOR_INFO_LOC+id, null);
