...
public class MothershipIntel  extends BaseIntelPlugin {
    ...
    static void log(final String message) {
        Global.getLogger(MothershipIntel.class).info(message);
    }
    //Initializer function
    public MothershipIntel(CampaignFleetAPI fleet) {
        this.fleet = fleet;
    ...
    protected void addBulletPoints(TooltipMakerAPI info, ListInfoMode mode) {
        ...
        String systemString = MothershipSpawner.getMothershipBaseLocation().getContainingLocation().getName();
        String entityString = MothershipSpawner.getMothershipBaseLocation().getName();
    ...
    public SectorEntityToken getMapLocation(SectorMapAPI map) {
        return MothershipSpawner.getMothershipBaseLocation();
    }
