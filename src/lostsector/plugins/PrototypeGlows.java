...
public class PrototypeGlows implements EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (colorInterval.intervalElapsed()) {
            //flux shift
            colorA = new Color(
                    ((MiscLS.clamp255(BASE_COLOR.getRed()))),
                    ((MiscLS.clamp255(BASE_COLOR.getGreen() - (int)(175 * fluxRatio)))),
                    ((MiscLS.clamp255(BASE_COLOR.getBlue() - (int)(160 * fluxRatio)))),
                    (MiscLS.clamp255(BASE_COLOR.getAlpha() + (int)(200 * fluxRatio))));
            //color jitter
            colorA = MiscLS.randomiseColor(colorA,(int)(-30 * fluxRatio), (int)(35 * fluxRatio), (int)(45 * fluxRatio), 0, false);
        }
        if (colorA!=null) {
