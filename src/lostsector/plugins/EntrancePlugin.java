...
public class EntrancePlugin extends BaseEveryFrameCombatPlugin {
    ...
    public void advance(float amount, List<InputEventAPI> events) {
        ...
        for (ShipAPI ship : Global.getCombatEngine().getShips()) {
            ...
            if (MiscLS.protOrEnigma(ship)==null) continue;

            if (MiscLS.isProtTech(ship)){
                ...
                Color nebColor;
                Color pColor;
                if (MiscLS.protOrEnigma(ship).equals("enigma")){
