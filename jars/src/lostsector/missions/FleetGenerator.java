...
public interface FleetGenerator {
    ...
    static enum GeneratorFleetTypes {
        ...
        private final FleetGenerator gen;

        private GeneratorFleetTypes(FleetGenerator gen) {
            this.gen = gen;
        }

        FleetDataAPI generate(MissionDefinitionAPI api, FleetSide side, String faction, float qf, float opBonus, int avgSMods, int maxPts, long seed, boolean autofit) {
            return gen.generate(api, side, faction, qf, opBonus, avgSMods, maxPts, seed, autofit);
        }
    }

    FleetDataAPI generate(MissionDefinitionAPI api, FleetSide side, String faction, float qf, float opBonus, int avgSMods, int maxPts, long seed, boolean autofit);

    static class RaidersGen implements FleetGenerator {

        @Override
        public FleetDataAPI generate(MissionDefinitionAPI api, FleetSide side, String faction, float qf, float opBonus, int avgSMods, int maxPts, long seed, boolean autofit) {
            ...
            return BaseRandomBattle.finishFleet(fleetEntity.getFleetData(), side, faction, api);
        }
    }

    static class PatrolGen implements FleetGenerator {
    ...
    static class HuntersGen implements FleetGenerator {
    ...
    static class WarGen implements FleetGenerator {
    ...
    static class DefenseGen implements FleetGenerator {
    ...
    static class ConvoyGen implements FleetGenerator {
    ...
    static class BlockadeGen implements FleetGenerator {
    ...
    static class InvasionGen implements FleetGenerator {
