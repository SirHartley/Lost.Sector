...
public class EnigmaFleetLoot extends BaseCampaignEventListener implements EveryFrameScript {
	...
	static void log(final String message) {
		Global.getLogger(EnigmaFleetLoot.class).info(message);
	}

	public EnigmaFleetLoot() {
		super(true);
	}
	...
	public void reportEncounterLootGenerated(FleetEncounterContextPlugin plugin, CargoAPI loot) {
		...
		if (enigmaHull != 0) {
			int electronicsCount = (int)(enigmaHull * SLOOT_PER_HULL_POINT * MathUtils.getRandomNumberInRange(0.70f, 1.30f));
			loot.addCommodity("nskr_electronics", electronicsCount);
		}
		//AI cores
