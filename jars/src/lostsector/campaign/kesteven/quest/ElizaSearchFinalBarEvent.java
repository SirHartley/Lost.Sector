...
public class ElizaSearchFinalBarEvent extends BaseBarEvent {
	...
	public ElizaSearchFinalBarEvent() {
	...
	public void optionSelected(String optionText, Object optionData) {
		...
		if (optionData== OptionId.A2){
			...
			text.addPara("The "+manOrWoman+" grabs the ornate shot glass, looks at it intently and then chugs it before continuing. " +
					"\"You should head to "+ QuestHelper.getElizaLoc().getName()+" in order to speak to her.\"",tc,h, QuestHelper.getElizaLoc().getName(),"");
