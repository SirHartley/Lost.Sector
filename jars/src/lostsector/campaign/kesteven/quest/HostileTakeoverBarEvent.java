...
public class HostileTakeoverBarEvent extends BaseBarEvent {
	...
	public HostileTakeoverBarEvent() {
	...
	public boolean shouldShowAtMarket(MarketAPI market) {
		if (QuestHelper.getStage()<=7) return false;
		return market==home.getMarket();
	}
	
	@Override
	public boolean shouldRemoveEvent() {
		return QuestHelper.getStage()>=10;
	}
	...
	public void optionSelected(String optionText, Object optionData) {
		...
		if (optionData==OptionId.E7){
			...
			String loc = QuestHelper.getJob3Target().getContainingLocation().getName();
		...
		if (optionData==OptionId.H7){
			...
			//acquire text
			//money
			float money = MathHelper.getSeededRandomNumberInRange(4000, 7000, random);
