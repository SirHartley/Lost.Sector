...
public class DelveMeetingBarEvent extends BaseBarEvent {
    ...
    public DelveMeetingBarEvent() {
        seed = Misc.random.nextLong();
        log("loaded");
    }

    static void log(final String message) {
        Global.getLogger(DelveMeetingBarEvent.class).info(message);
    }
