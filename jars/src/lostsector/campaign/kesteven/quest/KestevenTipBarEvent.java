...
public class KestevenTipBarEvent extends BaseBarEvent {
    ...
    static void log(final String message) {
        Global.getLogger(KestevenTipBarEvent.class).info(message);
    }
    ...
    public KestevenTipBarEvent(String id) {
        this.id = id;
    ...
    public void init(InteractionDialogAPI dialog, Map<String, MemoryAPI> memoryMap) {
        ...
        if (money==0f) money = 1000f* MathHelper.getSeededRandomNumberInRange(10, 30, getRandom());
    ...
    public void optionSelected(String optionText, Object optionData) {
        ...
        if (optionData==OptionId.LEAVE_BOUGHT){
            ...
            //intel
            Global.getSector().getIntelManager().addIntel(new KestevenTipIntel(getTipLocation().getStarSystem(), id, getThemeType(getTipLocation())), false);
    ...
    private StarSystemAPI getRandomSystemWithBlacklist(Random random) {
        ...
        SystemPicker simpleSystem = new SystemPicker(random, 0);
        //derelict
