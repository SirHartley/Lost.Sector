...
public class HellSpawnDisposableFleetSpawner extends DisposableFleetManager {
    ...
    protected CampaignFleetAPI spawnFleetImpl() {
        ...
        float combatPoints = MathHelper.getSeededRandomNumberInRange(20f, 80f, random);
        //power scaling
    ...
    private String getFaction() {
        ...
        return factions.get(MathHelper.getSeededRandomNumberInRange(0, factions.size() - 1, random));
    }
