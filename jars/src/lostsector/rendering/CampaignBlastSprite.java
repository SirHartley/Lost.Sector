...
public class CampaignBlastSprite extends BaseCustomEntityPlugin {
    //
    ...
    public static CampaignBlastSprite setupRender(Vector2f loc, SectorEntityToken entity, Random random, float duration, Color color){
        ...
        CampaignBlastSprite blast = (CampaignBlastSprite) plugin;
