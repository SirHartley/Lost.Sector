...
public class HellSpawnDummy extends BaseHullMod {

    static void log(final String message) {
        Global.getLogger(HellSpawnDummy.class).info(message);
    }
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        ...
        if (level>0){
            ...
            ship.addListener(new HellSpawnDamageListener(ship, level));
        }
