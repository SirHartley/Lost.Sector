...
public class AbsorbSystem extends BaseHullMod {
    //
    ...
    public void advanceInCombat(ShipAPI ship, float amount) {
        ...
        if (data.timer>0f){
            ...
            float bonus = MathHelper.lerp(0f, 1f, timerNorm);
            ...
            data.timer -= amount;
            if (player){
                float gain = MathHelper.lerp(1f, 0f, timerNorm);
        ...
        if (data.absorbed>0f){
            ...
            float mult = MathHelper.normalize(absorbed,0f, MIN_ENERGY);
