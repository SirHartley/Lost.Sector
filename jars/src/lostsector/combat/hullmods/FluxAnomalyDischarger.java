...
public class FluxAnomalyDischarger extends BaseHullMod {
	...
	public void advanceInCombat (ShipAPI ship,float amount) {
		...
		if (arcInterval.intervalElapsed()) {
			...
			for (int x = 0; x < 4; x++) {
				...
				particlePosTo = MathUtils.getPointOnCircumference(ship.getLocation(), radius, angle+ MathHelper.getRandomNumberInRangeExcludingRange(-40f, 40f,-10f,10f));
