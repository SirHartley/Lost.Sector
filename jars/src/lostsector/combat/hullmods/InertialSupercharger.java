...
public class InertialSupercharger extends BaseHullMod {
    ...
    static void log(final String message) {
        Global.getLogger(InertialSupercharger.class).info(message);
    }
    ...
    public void advanceInCombat(ShipAPI ship, float amount) {
        ...
        if (data.velocity>0f){
            ...
            float dmgNormalized = MathHelper.normalize(vel, 0f , max);
            ...
            for (WeaponAPI wep : ship.getAllWeapons()){
                ...
                if (spec.getType() == WeaponAPI.WeaponType.BALLISTIC || spec.getType() == WeaponAPI.WeaponType.ENERGY){
                    ...
                    if (wSprite!=null && wSprite.getHeight()>0f) {
                        RenderHelper.renderGlow(wep.getLocation(), wSprite.getHeight() * 0.33f, glow);
                    }
                }
            }
