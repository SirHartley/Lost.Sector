...
public class ProjectileFieldStats extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        for (CombatEntityAPI ent : CombatUtils.getEntitiesWithinRange(ship.getLocation(), range)){
            ...
            if (ent instanceof MissileAPI) {
                ...
                damage = MathHelper.normalize(damage, MIN_EFFECT_DMG, MAX_EFFECT_DMG);
                float mult = 0f;
                mult = MathHelper.lerp(1f, MAX_SLOWDOWN, damage);
            ...
            if (ent instanceof DamagingProjectileAPI) {
                ...
                damage = MathHelper.normalize(damage, MIN_EFFECT_DMG, MAX_EFFECT_DMG);
                float mult = 0f;
                mult = MathHelper.lerp(MAX_TURNRATE/3f, MAX_TURNRATE, damage);
                //direction check
