...
public class AdvanceStats extends BaseShipSystemScript {
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		if (ship == engine.getPlayerShip()) {
			if (dState>2) {
				//shader fx
				PostProcessShader.setNoise(false, MathHelper.lerp(0f, 0.15f, effectLevel));
				PostProcessShader.setLightness(false, MathHelper.lerp(1f, 1.15f, effectLevel));
				PostProcessShader.setSaturation(false, MathHelper.lerp(1f, 0.75f, effectLevel));
			}
