...
import lostsector.combat.weapons.BigFlakEffect;

public class BigFlakStats extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        BigFlakEffect.ShipSpecificData data = (BigFlakEffect.ShipSpecificData) Global.getCombatEngine().getCustomData().get("BIGFLAK_AI_DATA_KEY" + ship.getId());
