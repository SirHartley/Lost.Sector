...
public class CausalityStats extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        if (state == State.ACTIVE || state == State.OUT) {
            ...
            if (!activated) {
                ...
                targets.addAll(CombatHelper.getAsteroidsWithinRange(ship.getLocation(), range));
                ...
                for (CombatEntityAPI target : targets) {
                    ...
                    if (target instanceof DamagingProjectileAPI) {
                        ...
                        possibleTargets.addAll(CombatHelper.getShipsWithinRange(proj.getLocation(), 2500f));
                        float closest = 9999f;
                        //distance
            ...
            if (data.energy>maxEnergy) {
                ...
                if (!sideEffect && rand<0.20f){
                    ...
                    Vector2f point1 = CombatHelper.getRandomPointOnShip(ship);
    ...
    public static float getMaxRange(ShipAPI ship){
        ...
        return ship.getMutableStats().getSystemRangeBonus().computeEffective(PULL_RANGE);
    }
}
