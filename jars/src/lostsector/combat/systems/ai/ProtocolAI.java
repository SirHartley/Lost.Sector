...
public class ProtocolAI implements ShipSystemAIScript {
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (timer.intervalElapsed()) {
            ...
            ships.addAll(CombatHelper.getShipsWithinRange(ship.getLocation(), analysisRange+150f));
            ...
            fighters.addAll(CombatHelper.getShipsWithinRange(ship.getLocation(), 400));
            ...
            possibleTargets.addAll(CombatHelper.getMissilesWithinRange(ship.getLocation(), 600f));
