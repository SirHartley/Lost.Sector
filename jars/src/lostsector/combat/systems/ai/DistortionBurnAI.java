...
import lostsector.combat.systems.DistortionBurnStats;
...
public class DistortionBurnAI implements ShipSystemAIScript {
    ...
    private boolean nothingCanStopMe(ShipAPI ship) {
        ...
        List<ShipAPI> consider = CombatHelper.getShipsWithinRange(curr, SCAN_RANGE);
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (timer.intervalElapsed()) {
            ...
            //anti salamander
            for (MissileAPI m : CombatHelper.getMissilesWithinRange(ship.getLocation(), 350f)){
            ...
            //anti-fighter / flank
            int targetCount = 0;
            for (ShipAPI s : CombatHelper.getShipsWithinRange(ship.getLocation(), DistortionBurnStats.ARC_MAX_RANGE)){
