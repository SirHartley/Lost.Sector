...
public class UnchainedAI implements ShipSystemAIScript {
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (timer.intervalElapsed()) {
            ...
            possibleTargets.addAll(CombatHelper.getProjectilesWithinRange(ship.getLocation(), 600f));
            possibleTargets.addAll(CombatHelper.getMissilesWithinRange(ship.getLocation(), 750f));
            ...
            ships.addAll(CombatHelper.getShipsWithinRange(ship.getLocation(), 400f));
