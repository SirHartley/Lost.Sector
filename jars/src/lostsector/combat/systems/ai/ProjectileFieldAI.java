...
import lostsector.combat.systems.ProjectileFieldStats;
...
public class ProjectileFieldAI implements ShipSystemAIScript {
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (timer.intervalElapsed()) {
            ...
            for (CombatEntityAPI possibleTarget : CombatUtils.getEntitiesWithinRange(ship.getLocation(), ProjectileFieldStats.getMaxRange(ship))){
