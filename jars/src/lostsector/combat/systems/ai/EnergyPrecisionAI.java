...
import lostsector.combat.systems.EnergyPrecisionStats;
...
public class EnergyPrecisionAI implements ShipSystemAIScript {
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (tracker.intervalElapsed()) {
            ...
            float analysisRange = this.getLongestRange(this.ship) + EnergyPrecisionStats.RANGE_BONUS;
