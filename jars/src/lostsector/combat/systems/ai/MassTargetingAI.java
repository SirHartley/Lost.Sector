...
import lostsector.combat.systems.MassTargetingStats;
...
public class MassTargetingAI implements ShipSystemAIScript {
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {
        ...
        if (tracker.intervalElapsed()) {
            ...
            float analysisRange = this.getLongestRange(this.ship)*(1f+(MassTargetingStats.TARGETING_BONUS/10f));
            ...
            friendlies.addAll(AIUtils.getNearbyAllies(ship, MassTargetingStats.getMaxRange(ship)));
