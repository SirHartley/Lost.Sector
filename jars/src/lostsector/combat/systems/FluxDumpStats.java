...
public class FluxDumpStats extends BaseShipSystemScript {

	public static final float DISSIPATION = 2500f;
	public static final float SPEED_BONUS = 150f;
	public static final float MANEUVER_BONUS = 100f;
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		float t = MathHelper.normalize(amount, 0f, DURATION);
		//reverse parabola
