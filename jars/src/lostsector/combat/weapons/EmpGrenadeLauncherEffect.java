...
// Sticky grenade bits by Tartiflette
///////////////////////////////
...
public class EmpGrenadeLauncherEffect implements EveryFrameWeaponEffectPlugin {
    ...
    private final Map<CombatEntityAPI, Boolean> detonation= new HashMap<>(); //to check for synch detonations
    private final List<CombatEntityAPI> hit = new ArrayList<>(); //to transmit the target from the projectile to the pike missile
    ...
    */
    ...
    static {
        ...
        ON_SHOT_PARTICLE_COUNT.put("NSKR_SMOKE_5", 10);
    }
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(54, 46, 43, 105));
        PARTICLE_COLOR.put("NSKR_SMOKE_1", new Color(56, 50, 50, 105));
        PARTICLE_COLOR.put("NSKR_SMOKE_3", new Color(110, 102, 102, 105));
        PARTICLE_COLOR.put("NSKR_SMOKE_5", new Color(56, 50, 50, 105));
        PARTICLE_COLOR.put("NSKR_FLASH_FRINGE_1", new Color(255, 173, 65, 255));
        PARTICLE_COLOR.put("NSKR_FLASH_CORE_1", new Color(255, 250, 212, 255));
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("NSKR_FLASH_FRINGE_1", 40f);
        PARTICLE_SIZE_MIN.put("NSKR_FLASH_CORE_1", 20f);
    }
    ...
    static {
        ...
        PARTICLE_VELOCITY_MAX.put("NSKR_SMOKE_5", 20f);
    }
    ...
    static {
        PARTICLE_OFFSET_MAX.put("default", 30f);
        PARTICLE_OFFSET_MAX.put("NSKR_SMOKE_3", 25f);
        PARTICLE_OFFSET_MAX.put("NSKR_FLASH_FRINGE_1", 0f);
        PARTICLE_OFFSET_MAX.put("NSKR_FLASH_CORE_1", 0f);
        PARTICLE_OFFSET_MAX.put("NSKR_SMOKE_5", 5f);
    }
    ...
    //Instantiator
    public EmpGrenadeLauncherEffect() {}
