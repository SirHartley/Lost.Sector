...
public class Stasis {
    ...
    public static class stasisEffectListener implements AdvanceableListener {
        ...
        public void advance(float amount) {
            ...
            speedMod = MathHelper.lerp(1f, MAX_SPEED_MULT, mod);
            agilityMod = MathHelper.lerp(1f, MANEUVER_MULT, mod);
            weaponTurnMod = MathHelper.lerp(1f, WEAPON_SPEED_MULT, mod);
            ...
            if (Math.random()<1.00f * (engine.getElapsedInLastFrame()*60f)) {
                ...
                Global.getCombatEngine().addSmokeParticle(particlePos, MathHelper.scaleVector(particleVel, 0.1f), 5f, 0.67f, 1f,
                        COLOR);
            }
        }
    }
    ...
    public static void explode(Vector2f point, ShipAPI source) {
        ...
        for (int x = 0; x < 150; x++) {
            ...
            Global.getCombatEngine().addSmokeParticle(particlePos, MathHelper.scaleVector(particleVel, 0.25f), 4f, 0.50f, 1.5f,
                    color);
        }
    }
}