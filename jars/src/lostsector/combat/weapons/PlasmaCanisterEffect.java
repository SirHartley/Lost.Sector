...
public class PlasmaCanisterEffect implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        ...
        PARTICLE_COLOR.put("NSKR_FLASH_FRINGE_1", new Color(65, 160, 255));
        PARTICLE_COLOR.put("NSKR_FLASH_CORE_1", new Color(212, 234, 255));
    }
