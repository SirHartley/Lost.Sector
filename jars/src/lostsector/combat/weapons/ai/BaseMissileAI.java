...
public class BaseMissileAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    static List<ShipAPI> getSortedDirectTargets(ShipAPI launchingShip) {
        List<ShipAPI> directTargets = CombatHelper.getShipsWithinRange(launchingShip.getMouseTarget(), 300f);
    ...
    public BaseMissileAI(MissileAPI missile, ShipAPI launchingShip) {
