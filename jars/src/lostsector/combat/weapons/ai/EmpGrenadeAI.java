...
//By Tartiflette.
//////////////////////
package lostsector.combat.weapons.ai;

import com.fs.starfarer.api.Global;
import com.fs.starfarer.api.combat.*;
import com.fs.starfarer.api.util.IntervalUtil;
import lostsector.combat.weapons.EmpGrenadeLauncherEffect;
...
public class EmpGrenadeAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public EmpGrenadeAI(MissileAPI missile, ShipAPI launchingShip) {
    ...
    public void advance(float amount) {
        ...
        if (!runOnce) {
            runOnce = true;
            List<CombatEntityAPI> list = ((EmpGrenadeLauncherEffect) missile.getWeapon().getEffectPlugin()).getHITS();
            ...
            ((EmpGrenadeLauncherEffect) missile.getWeapon().getEffectPlugin()).setDetonation(anchor);
            ...
            if (anchor == null || ((EmpGrenadeLauncherEffect) missile.getWeapon().getEffectPlugin()).getDetonation(anchor)) {
