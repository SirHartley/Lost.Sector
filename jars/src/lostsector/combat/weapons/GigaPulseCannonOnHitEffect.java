...
public class GigaPulseCannonOnHitEffect implements OnHitEffectPlugin {
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
        ...
        //AOE DMG
        CombatHelper.applyAOEDamage(projectile.getSource(), target, point, projectile.getDamageAmount(), projectile.getDamageType(), 600f, false);
        ...
        CombatHelper.createHitParticles(point, projectile.getFacing(), 45f, HIT_PARTICLE_COLOR, 25f, 5f, 0.3f, 1.0f, 50f, 3.0f);
