...
public class CacheBossTauntPlugin extends BaseEveryFrameCombatPlugin {
    ...
    static {
        BOSS_KEYS.add(Cache.CACHE_FLEET_KEY);
    }
    ...
    public CacheBossTauntPlugin() {
    }

    static void log(final String message) {
        Global.getLogger(CacheBossTauntPlugin.class).info(message);
    }
