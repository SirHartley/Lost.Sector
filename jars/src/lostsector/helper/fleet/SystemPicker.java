...
public class SystemPicker {
    ...
    static void log(final String message) {
        Global.getLogger(SystemPicker.class).info(message);
    }
    ...
    public SystemPicker(Random random, int minPlanets) {
        this.random = random;
    ...
    public StarSystemAPI pick(){
        ...
        return systems.get(MathHelper.getSeededRandomNumberInRange(0,systems.size()-1, random));
    }
