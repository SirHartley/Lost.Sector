...
public class SimpleFleet {
    ...
    public CampaignFleetAPI create(){
        ...
        if (flagshipInfo!=null){
            //ADDING FLAGSHIP
            FleetMemberAPI flagship = FleetHelper.generateShip(flagshipInfo.variant, flagshipInfo.noAutofit, flagshipInfo.alwaysRecover, flagshipInfo.variantTags, flagshipInfo.hullmods);
