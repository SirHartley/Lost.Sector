...
public class MissionDefinition extends BaseRandomBattle {
    ...
    private static boolean autofit;
    ...
    public void defineMission(MissionDefinitionAPI api) {
        ...
        FleetDataAPI playerFleetData = generateFleet(playerSize, (float) playerQualityFactor / 100f, (float) playerOPBonus, playerSMods, FleetSide.PLAYER, playerFaction, playerFleet, api, playerSeed, autofit);
        FleetDataAPI enemyFleetData = generateFleet(enemySize, (float) enemyQualityFactor / 100f, (float) enemyOPBonus, enemySMods, FleetSide.ENEMY, enemyFaction, enemyFleet, api, enemySeed, autofit);
